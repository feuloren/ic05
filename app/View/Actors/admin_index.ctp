<div class="actors index">
	...
	<tr>
		...
		<td><?php echo h($actor['Actor']['firstName']); ?>&nbsp;</td>
		<td><?php echo h($actor['Actor']['lastName']); ?>&nbsp;</td>
		<td><?php echo h($actor['Actor']['email']); ?>&nbsp;</td>
		<td><?php echo h($actor['Actor']['description']); ?>&nbsp;</td>
		<td><?php echo h($actor['Actor']['type']); ?>&nbsp;</td>
		<td><?php echo h($actor['Actor']['file']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $actor['Actor']['id']), null, __('Are you sure you want to delete # %s?', $actor['Actor']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
